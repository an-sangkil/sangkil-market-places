...
| 에이전트 | 참조 문서 |
|----------|-----------|
| `requirements-todo-planner` | `planning/execution-plan-template.md`, `planning/requirement-analysis-checklist.md` |
| `backend-implementation` | `development/testing-patterns.md`, `development/security-checklist.md` |
