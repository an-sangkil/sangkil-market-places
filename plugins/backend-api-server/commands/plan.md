...
- **도메인명이 주어진 경우**: `document/exec-plans/{domain}/requirements.md` 사용
- **파일 경로가 주어진 경우**: 해당 경로 사용
- **인자가 없는 경우**:
  - `ls -lt document/exec-plans/*/requirements.md | head -5`로 최근 스펙 후보 제시
...
`document/exec-plans/{domain}/plan.md`
